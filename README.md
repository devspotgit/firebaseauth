...
This is simple project that describes how to handle authentication with **firebase web SDK**.

The app is implementing **Email and Password** based authentication, and third party authentication through **Google and Github**.
